...
"Un sendero antiguo que sube hacia una colina cubierta de niebla.\n")
    ...
    if da == "A" or da == "a":
        ...
        if d2 == "A" or d2 == "a":
            print("Una maldición te convierte en piedra. (Final: Eres una estatua más.)\n")

        elif d2 == "B" or d2 == "b":
            print("Regresas a la playa, pero ya es de noche.(Mueres por las criaturas que acechan por la noche).")
    ...
    if decisionb == "a" or decisionb == "A":
        ...
        if decisionba == "a" or decisionba == "A":
            ...
            if decisionbaa == "a" or decisionbaa == "A":
                ...
                print("¿Que elijes?")
                decisionbaaa = input("A)TE QUEDAS A PROTEGER EL TEMPLO.\nB)HUYES DEL TEMPLO\n")
                
                if decisionbaaa == "A" or decisionbaaa == "a":
                    print("Te quedas a proteger el templo por el resto de la eternidad. fin")
                elif decisionbaaa == "B" or decisionbaaa == "b":
                    print("Intestas escapar del templo pero te teletransportas a un lugar al azar del templo donde quedas atrapado para siempre. fin")
                else:
                    print("opcion invalida")
               

            elif decisionbaa == "B" or decisionbaa == "b":
                print("huyes del templo y esperas en la playa a que te rescaten pero nunca llega nadie. fin")
            else:
                print("opcion invalida")
